...
import com.mtsearch.operation.bean.entity.system.Menu;
...
public class MenuController extends BaseController {
    ...
    public Object menuTreeListByRoleId(Integer roleId) {
        ...
        Map<Long, ZTreeNode> map = com.mtsearch.operation.utils.Lists.toMap(roleTreeList, "id");
        Map<Long, List<ZTreeNode>> group = com.mtsearch.operation.utils.Lists.group(roleTreeList, "pId");
